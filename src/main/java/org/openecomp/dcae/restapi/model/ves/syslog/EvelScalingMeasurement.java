...
//	}
	...
	public ArrayList<MEASUREMENT_VNIC_PERFORMANCE> getVnic_usage() {
		return vnic_usage;
	}

	public void setVnic_usage(ArrayList<MEASUREMENT_VNIC_PERFORMANCE> vnic_usage) {
		this.vnic_usage = vnic_usage;
	}
	...
	public ArrayList<MEASUREMENT_CPU_USE> getCpu_usage() {
		return cpu_usage;
	}

	public void setCpu_usage(ArrayList<MEASUREMENT_CPU_USE> cpu_usage) {
		this.cpu_usage = cpu_usage;
	}

	public ArrayList<MEASUREMENT_MEM_USE> getMem_usage() {
		return mem_usage;
	}

	public void setMem_usage(ArrayList<MEASUREMENT_MEM_USE> mem_usage) {
