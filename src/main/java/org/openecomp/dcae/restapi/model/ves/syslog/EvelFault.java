...
public class EvelFault extends EvelHeader {
	...
	/***************************************************************************/
	  ...
	  ArrayList<String[]> additional_info;
		...
		public String memoryConfigured;
	  ...
	  public String getMemoryFree() {
		...
		public String getMemoryConfigured() {
			return memoryConfigured;
		}

		public void setMemoryConfigured(String memoryConfigured) {
	 ...
	 *****************************************************************************/
	public static String evel_source_type(EVEL_SOURCE_TYPES source_type)
	{
	  String result;
	...
	public EVEL_SEVERITIES getEvent_severity() {
		return event_severity;
	}

	public void setEvent_severity(EVEL_SEVERITIES event_severity) {
		this.event_severity = event_severity;
	}

	public EVEL_SOURCE_TYPES getEvent_source_type() {
		return event_source_type;
	}

	public void setEvent_source_type(EVEL_SOURCE_TYPES event_source_type) {
	...
	public EVEL_VF_STATUSES getVf_status() {
		return vf_status;
	}

	public void setVf_status(EVEL_VF_STATUSES vf_status) {
		this.vf_status = vf_status;
	}

	public EvelOptionString getCategory() {
		return category;
	}

	public void setCategory(EvelOptionString category) {
