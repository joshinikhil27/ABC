...
import org.openecomp.dcae.restapi.model.ves.syslog.EvelFault.EVEL_SEVERITIES;
...
public class EvelSyslog extends EvelHeader {
     ...
     *****************************************************************************/
	  public String evel_json_encode_event()
	  {
		EVEL_ENTER();
	  ...
	  public void setValuesForOptionalField()
	  {
		  	syslog_facility = new EvelOptionInt();
		    syslog_priority = new EvelOptionInt();
		    syslog_proc_id = new EvelOptionInt();
	...
	public EvelFault.EVEL_SOURCE_TYPES getEvent_source_type() {
		return event_source_type;
	}
	public void setEvent_source_type(EvelFault.EVEL_SOURCE_TYPES event_source_type) {
		this.event_source_type = event_source_type;
	}
	public EvelOptionInt getSyslog_facility() {
		return syslog_facility;
	}

	public void setSyslog_facility(EvelOptionInt syslog_facility) {
		this.syslog_facility = syslog_facility;
	}
	public String getSyslog_msg() {
		return syslog_msg;
	}
	public void setSyslog_msg(String syslog_msg) {
		this.syslog_msg = syslog_msg;
	}
	public EvelOptionString getEvent_source_host() {
		return event_source_host;
	}
	public void setEvent_source_host(EvelOptionString event_source_host) {
		this.event_source_host = event_source_host;
	}
	...
	public String getSyslog_tag() {
		return syslog_tag;
	}
	public void setSyslog_tag(String syslog_tag) {
		this.syslog_tag = syslog_tag;
	}
	public EVEL_SYSLOG_FACILITIES getFacility() {
		return facility;
	}
	public void setFacility(EVEL_SYSLOG_FACILITIES facility) {
